...
## Set Write.pdf below to 'T' if you want pdf output.
...
for(stock in stocks) {
  ...
  plot(x=yr, y=ct.raw, 
       ...
       type ="l", bty="l", main=paste("A: Catch"), xlab="", ylab="Catch (x1000 tonnes/year)", lwd=2, cex.main = 2, cex.lab = 1.55, cex.axis = 1.5)
  lines(x=yr,y=ct,col="blue", lwd=1)
  points(x=yr[max.yr.i], y=max.ct, col="red", lwd=2)
  points(x=yr[min.yr.i], y=min.ct, col="red", lwd=2)

  # plot r-k graph ----
  plot(x=ri1, y=ki1, xlim = start.r, ylim = start.k, log="xy", xlab="", ylab="k", 
       main="B: Finding viable r-k", pch=".", cex=3, bty="l", col="gray95", cex.main = 2, cex.lab = 1.55, cex.axis = 1.5)
...
plot(x=rv.all, y=kv.all, xlim=start.r, 
     ...
     xlab="", ylab="k (1000 tonnes)", main="C: Analysis of viable r-k",  cex.main = 2, cex.lab = 1.55, cex.axis = 1.5)
title(xlab = "r", line = 2.25, cex.lab = 1.55)
...
plot(x=yr,y=median.btv[1:nyr], lwd=1.5, xlab="", ylab="Relative biomass B/k", type="l",
     ylim=c(0,max.y), bty="l", main="D: Biomass",col="blue",  cex.main = 2, cex.lab = 1.55, cex.axis = 1.5)
...
plot(x=yr,y=F.CMSY/Fmsy.CMSY, type="l", bty="l", lwd=1.5, ylim=c(0,max.y), xlab="", 
     ylab="F / (r/2)", main="E: Exploitation rate", col="blue",  cex.main = 2, cex.lab = 1.55, cex.axis = 1.5)
...
plot(x=x, y=y, xlim=c(1,0), ylim=c(0,max.y), type="l", bty="l",xlab="", 
     ylab="Catch / MSY", main="F: Equilibrium curve",  cex.main = 2, cex.lab = 1.55, cex.axis = 1.5)
...
if(mgraphs==T) {
  ...
  plot(x=yr,rep(0,nyr),type="n",ylim=c(0,max.y), bty="l", main=paste("Catch"), 
       xlab="",ylab="Catch (x1000 tonnes/year)",  cex.main = 2, cex.lab = 1.35, cex.axis = 1.35)
  ...
  #----------------------------------------
  # plot empty frame
  plot(yr, rep(0,nyr),type="n", ylim=c(0,max(c(2, max(ucl.B.Bmsy)))), ylab="B / Bmsy",xlab="", main="Biomass", bty="l",  cex.main = 2, cex.lab = 1.35, cex.axis = 1.35) 
  ...
  plot(yr, rep(0,nyr),type="n", ylim=c(0,max(c(2, ifelse(max(ucl.F.Fmsy)<5,max(ucl.F.Fmsy),5)))), 
       ylab="F / Fmsy",xlab="", main="Exploitation", bty="l",  cex.main = 2, cex.lab = 1.35, cex.axis = 1.35)  
  ...
  #Create plot
  plot(1000,1000,type="b", xlim=c(0,max.x), ylim=c(0,max.y),lty=3,xlab="",ylab="B / Bmsy", bty="l",  cex.main = 2, cex.lab = 1.35, cex.axis = 1.35)
...
\\setlength\\parindent{0pt}
  ...
  Sweave(documentfile)
  tools::texi2pdf(paste(documentfile,".tex",sep=""))
  cat("PDF document is ",paste(documentfile,".pdf",sep=""))
